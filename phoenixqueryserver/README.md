...
# Phoenix Query Server for YCSB
This driver is a binding for the YCSB facilities to operate against a Phoenix Query Server cluster.
...
### 1. Setup a Phoenix query server Cluster
