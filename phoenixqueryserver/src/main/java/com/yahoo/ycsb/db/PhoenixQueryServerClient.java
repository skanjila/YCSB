...
/**
 * Phoenix Query Server client for YCSB framework.
 *
 * A modified version of Phoenix Query Server which uses the avatica
 * protocol buffers to run performance tests against PQS
 */
public class PhoenixQueryServerClient extends com.yahoo.ycsb.DB {
