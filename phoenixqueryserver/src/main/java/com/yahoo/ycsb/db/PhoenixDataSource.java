...
/**
 * A connection pooling implementation for hbase, uses a queue underneath
 */
...
public class PhoenixDataSource {
  ...
  public PhoenixDataSource(String driverClass, String jdbcUrl, String user, String password, int min, int max) {
